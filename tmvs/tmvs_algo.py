...
from common.data_reading_utils import ReadoutList, hamming_distance, read_codebook
from tmvs.utils import read_enrollment_info, enrolled_key_dir, regenerated_key_dir
    ...
    def process(readouts: ReadoutList, code_length:int, margin_coeff: list[float]):
        ...
        for i in range(1,len(readouts)): # skip first readout
            ...
            for j, reference_key_bit in enumerate(reference_key):
                ...
                if hd <= np.floor(n * data_const.P_SRAM):
