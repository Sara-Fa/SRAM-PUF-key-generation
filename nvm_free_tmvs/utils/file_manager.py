...
# filepath to store hamming distances
hamming_distances_dir = pathlib.Path(__file__).parent.parent.absolute() / 'hamming_distances'

# filepath to store bit-error rate results
ber_comparator_dir = pathlib.Path(__file__).parent.parent.absolute() / 'BER_comparator_data'
